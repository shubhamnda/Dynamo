...
struct SlideToggleStyle: ToggleStyle {
    ...
    @State private var capsuleBackgroundColor: Color = .red.opacity(0.7) // Default color
    func makeBody(configuration: Configuration) -> some View {
        ...
        .onChange(of: isOn) { oldValue, newValue in
            ...
            withAnimation(.bouncy) {
                ...
                capsuleBackgroundColor = newValue ? Color.neonGreen.opacity(0.7) : .red.opacity(0.7)
            }
        }
    ...
    private func toggleView(isOn: Binding<Bool>) -> some View {
        ZStack {
            ZStack {
                // Toggle Background
                Capsule()
                    .foregroundColor(capsuleBackgroundColor)
